...
# Eg_start = 0.062
# Eg_count = 80
# y_sweep = np.linspace(Eg_start, 0.2, Eg_count)
# y_id_str = 'Eg'
# args_to_opt = ['mu']
...
# filename = f'PD_cwv{cwv}_etaextlog_-4_0_{eta_count}_Egs_{Eg_start}_02_{Eg_count}.csv'
...
#     diodes_to_plt = [{'eta_ext':1e-2, 'Eg':0.1, 'style_args':{'marker':'o', 'color':'steelblue'}},
#                      {'eta_ext':1e-1, 'Eg':0.1, 'style_args':{'marker':'o', 'mfc':'none', 'mew':2, 'color':'steelblue'}}]
